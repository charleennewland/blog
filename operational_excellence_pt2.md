...
There are various definitions for operational excellence in literature, just as there are for continuous improvement. Each definition highlights a different angle but most share similarities. According to one study [1], there are 32 different definitions, with key focus areas spanning from employee and customer satisfaction to continuous development of operational performance. The common theme across these definitions is that operational excellence refers to the intended result or ideal state for a business. Now let's get into it.
