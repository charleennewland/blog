...
#### Tools and methods
The field of continuous improvement knows a wide variety of tools and methods. These are the methods used to improve business operations. Each of these methods has a particular purpose. Some are used for decision-making purposes and others to implement or execute initiatives. One literature review [6] into continuous improvement found 33 different continuous improvement tools, and another [7] lists 85 different improvement methods and tools. 
