...
This means that every employee actively and consistently looks for ways to reduce non-value added activity which should result in an increase in productivity and profitability. Nakajami's work [5] states that after successful continuous improvement implementation, some cases show that companies were able to reduce maintenance costs by 15% to 30%, while others revealed a 90% reduction in process defects and a 40%–50% gain in labour productivity.
